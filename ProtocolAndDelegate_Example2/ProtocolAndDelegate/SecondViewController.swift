...
class SecondViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func saveButtonClicked(_ sender: Any) {
       ...
       // delegate.dataPassing(name: nameTextField.text ?? "0", age: ageTextField.text ?? "0", city: cityTextField.text ?? "0")
        ...
        let dataDictFromTextField:[String:String] = ["name":nameTextField.text!, "age":ageTextField.text!, "city": cityTextField.text!]
        
        delegate.data(object: dataDictFromTextField)
    }
